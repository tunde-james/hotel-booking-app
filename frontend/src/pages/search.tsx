...
const Search = () => {
  ...
  return (
    <div className="grid grid-cols-1 gap-5 lg:grid-cols-[250px_1fr]">
      <div className="rounded-lg border-slate-300 border-[1px] p-5 h-fit lg:sticky lg:top-10">
        <div className="space-y-5">
          <h3 className="text-sm font-semibold border-b border-slate-300 pb-5 lg:text-lg">
            Filter by:
          </h3>
